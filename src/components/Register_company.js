        ...
        <div className="">
          ...
          <Form onSubmit={onSubmit} initialValues={{ name: '', companyStatus: '', managerId: '' }} validate={validate} render={({ handleSubmit }) => (
            <form onSubmit={handleSubmit} className="p-fluid">
                ...
                <div className="field col-11 md:col-4">
                  <Field
                    name="managerId"
                    render={({ input, meta }) => (
                      <div className="field">
                ...
                <div className="field col-11 md:col-3">
                  <Field
                    name="companyStatus"
                    render={({ input, meta }) => (
                      <div className="field">
                        <span className="p-float-label">
                          <Dropdown id="companyStatus" {...input} options={statusOptions} optionLabel="label" />
                ...
                <div className="field col-11 md:col-4 align-items-center">
